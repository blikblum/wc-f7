    ...
    return html`
      ...
      <div class="page-content">
        ...
        <div class="block block-strong">
          ...
          <p class="row">
            <a href="#" class="col button button-large button-fill button-raised color-red"
              >Large Red</a
            >
            <a href="#" class="col button button-large button-fill button-raised color-green"
              >Large Green</a
            >
          </p>
        </div>
          ...
          <ul>
            <li>
              <label class="item-checkbox item-content">
                <input type="checkbox" name="checkbox" value="Books" checked />
          ...
          <ul>
            <li>
              <label class="item-radio item-content">
                <input type="radio" name="radio" value="Books" checked />
